...
void lcd_init()
{
    ...
    DATA_PORT = 0x38; lcd_pulse();
    DATA_PORT = 0x06; lcd_pulse();
    DATA_PORT = 0x0C; lcd_pulse();
    DATA_PORT = 0x01; lcd_pulse();
    RS = 1;
}
